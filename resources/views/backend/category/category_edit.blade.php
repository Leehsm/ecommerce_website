                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <form method="post" action="{{ route('category.update','$category->id') }}" >
                            ...
                            <div class="form-group">
                                <h5>Category Name Malay <span class="text-danger">*</span></h5>
                                <div class="controls">
                                    <input type="text" name="category_name_my" id="category_name_my" class="form-control" value="{{ $category->category_name_my }}"> 
