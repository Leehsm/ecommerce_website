                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->subsubcategory_name_my }}</td>
                    ...
                    <div class="table-responsive">
                        <form method="post" action="{{ route('subsubcategory.store') }}" >
                            ...
                            <div class="form-group">
								...
								<div class="controls">
									<select name="subcategory_id" id="catsubcategory_idgory_id" class="form-control" >
                            ...
                            <div class="form-group">
                                <h5>Sub Sub Category Name Malay <span class="text-danger">*</span></h5>
                                <div class="controls">
                                    <input type="text" name="subsubcategory_name_my" id="subsubcategory_name_my" class="form-control"> 
