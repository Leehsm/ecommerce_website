                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->subcategory_name_my }}</td>
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <form method="post" action="{{ route('subcategory.store') }}" >
                            ...
                            <div class="form-group">
                                <h5>Sub Category Name Malay <span class="text-danger">*</span></h5>
                                <div class="controls">
                                    <input type="text" name="subcategory_name_my" id="subcategory_name_my" class="form-control"> 
