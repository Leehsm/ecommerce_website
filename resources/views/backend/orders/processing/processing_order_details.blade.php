...
<!-- Content Header (Page header) -->
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="page-title">Processing Order Details</h3>
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                            <li class="breadcrumb-item" aria-current="page">Processing Order</li>
                            <li class="breadcrumb-item active" aria-current="page">Processing Order Details</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="box box-bordered border-primary">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th> Order : </th>
                            <th> 
                                <span class="badge badge-pill badge-light">{{ $order->status }} </span> 
                            </th>
                        </tr>
                        <tr>
                            <th> </th>
